...
def classify_regime(
    ...
    if trend == "downtrend":
        ...
        return Regime(
            ...
            vix=vix,
            strategies=(),
            rationale="Downtrend and this account is long-only; no valid "
                      "strategy. Correct action is to sit out.",
        )
    ...
    return Regime(
        ...
        vix=vix,
        strategies=("S1",),
        rationale=f"Uptrend, VIX {vix:.1f} between {VIX_LOW} and {VIX_HIGH}. "
                  "Ambiguous volatility; defaulting to the trend strategy "
                  "rather than the momentum scan.",
    )
